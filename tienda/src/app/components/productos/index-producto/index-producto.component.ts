...
export class IndexProductoComponent implements OnInit {
  ...
  order_por(){
    ...
    }else if(this.sort_by == 'Popularidad'){ //Numero de ventas por producto ( de mayor venta a menor venta)
    ...
    } else if(this.sort_by == '+-precio'){ //Numero de ventas por producto ( de mayor venta a menor venta)
      this.productos.sort(function(a,b){
    ...
    }else if(this.sort_by == 'azTitulo'){ //Numero de ventas por producto ( de mayor venta a menor venta)
      this.productos.sort(function(a,b){
    ...
    }else if(this.sort_by == 'zaTitulo'){ //Numero de ventas por producto ( de mayor venta a menor venta)
      this.productos.sort(function(a,b){
        if(a.titulo < b.titulo){
          return 1;
        }
