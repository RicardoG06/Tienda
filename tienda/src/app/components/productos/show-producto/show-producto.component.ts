...
export class ShowProductoComponent implements OnInit {
  ...
  ngOnInit(): void {
        //Se uso tiny Slider , es una libreria que sirve para la estructuracion de la galeria
    setTimeout(()=>{
      tns({
      ...
      //Se uso lightGallery , es una libreria para el acercamiento de los objetos dentro de la galeria
    ...
    if (e.length){
     ...
     //Inicializando lightGallery para los productos recomendados
     tns({
